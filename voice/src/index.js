...
// Education Page: Three Div Boxes for Game Options (Displayed when clicking Education)
      ...
      <main>
        <Routes>
          ...
          <Route path="/" element={
            <>
              <HeroSection />
              <MiddlePart /> {/* You can remove this if you don't want MiddlePart */}
            </>
          } />

          {/* Education Route - Show div boxes for games */}
